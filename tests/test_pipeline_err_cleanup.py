...
def _config(tmp_path: Path, *, postprocessing=False, file_summarization=False, dir_summarization=False) -> Config:
    return Config(
        ...
        file_summarization=OllamaStepConfig(llm_enabled=file_summarization, output_suffix="_sum.txt"),
        dir_summarization=OllamaStepConfig(llm_enabled=dir_summarization, output_suffix="_sum.txt"),
