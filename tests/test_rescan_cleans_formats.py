...
class TestCleanOtherFormatsUnit:
    def test_err_file_untouched(self, tmp_path):
        ...
        Cleaner(CleanupConfig(), "md").clean_other_formats(tmp_path / "rec.mp3")
    ...
    def test_dry_run_does_not_delete(self, tmp_path):
        ...
        Cleaner(CleanupConfig(), "md").clean_other_formats(tmp_path / "rec.mp3", dry_run=True)
    ...
    def test_per_engine_labels(self, tmp_path):
        ...
        Cleaner(CleanupConfig(), "md", engine_labels=["_whisperx"]).clean_other_formats(
            tmp_path / "rec.mp3"
        )
